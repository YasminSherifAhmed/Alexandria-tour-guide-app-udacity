package com.example.hp.alextourguideapp3;
...
public class AccomodationFragment extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String[] accomodationNames = getResources().getStringArray(R.array.list_accommodation_names);
        final String[] accomodationAddresses = getResources().getStringArray(R.array.list_accommodation_addresses);
        final String[] accomodationOpeningHours = getResources().getStringArray(R.array.list_accommodation_opening_hours);
        final TypedArray accomodationImages = getResources().obtainTypedArray(R.array.list_accommodation_images);
